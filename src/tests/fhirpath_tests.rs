...
mod test_official {
    ...
    fn test_distinct_test_distinct_4_229() {
        ...
        assert_json_eq!(
            evaluate_result.ok(), serde_json::from_str:: < Value > ("[1.0,2.0,3.0]")
            .unwrap()
        )
    }
    #[test]
    fn test_distinct_test_distinct_5_230() {
        ...
        assert_json_eq!(
            evaluate_result.ok(), serde_json::from_str:: < Value > ("[10.0]").unwrap()
        )
    }
    #[test]
    fn test_distinct_test_distinct_6_231() {
        ...
        assert_json_eq!(
            evaluate_result.ok(), serde_json::from_str:: < Value > ("[2.0]").unwrap()
        )
    }
    #[test]
    fn test_count_test_count_1_232() {
        ...
        assert_json_eq!(
            evaluate_result.ok(), serde_json::from_str:: < Value > ("[3.0]").unwrap()
        )
    }
    #[test]
