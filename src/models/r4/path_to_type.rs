...
pub fn path_to_type() -> HashMap<String, String> {
    ...
    map.insert("Account.partOf".to_string(), "Reference".to_string());
    ...
    map.insert("AdverseEvent.contributor".to_string(), "Reference".to_string());
    ...
    map.insert("AdverseEvent.event".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("AdverseEvent.resultingCondition".to_string(), "Reference".to_string());
    map.insert("AdverseEvent.seriousness".to_string(), "CodeableConcept".to_string());
    map.insert("AdverseEvent.severity".to_string(), "CodeableConcept".to_string());
    ...
    map.insert(
        "Appointment.cancelationReason".to_string(),
        "CodeableConcept".to_string(),
    );
    ...
    map.insert("Appointment.patientInstruction".to_string(), "string".to_string());
    map.insert("Appointment.priority".to_string(), "unsignedInt".to_string());
    map.insert("Appointment.reasonCode".to_string(), "CodeableConcept".to_string());
    map.insert("Appointment.reasonReference".to_string(), "Reference".to_string());
    ...
    map.insert("AuditEvent.agent.network.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("AuditEvent.period".to_string(), "Period".to_string());
    ...
    map.insert(
        "BiologicallyDerivedProduct.manipulation".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "BiologicallyDerivedProduct.processing".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "BiologicallyDerivedProduct.processing.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("BiologicallyDerivedProduct.quantity".to_string(), "integer".to_string());
    map.insert(
        "BiologicallyDerivedProduct.request".to_string(),
        "Reference".to_string(),
    );
    map.insert("BiologicallyDerivedProduct.status".to_string(), "code".to_string());
    map.insert(
        "BiologicallyDerivedProduct.storage".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "BiologicallyDerivedProduct.storage.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "BiologicallyDerivedProduct.storage.scale".to_string(),
        "code".to_string(),
    );
    map.insert(
    ...
    map.insert("BodyStructure.description".to_string(), "string".to_string());
    ...
    map.insert("BodyStructure.location".to_string(), "CodeableConcept".to_string());
    map.insert(
        "BodyStructure.locationQualifier".to_string(),
        "CodeableConcept".to_string(),
    );
    ...
    map.insert(
        "CarePlan.activity.detail.doNotPerform".to_string(),
        "boolean".to_string(),
    );
    map.insert(
    ...
    map.insert("CarePlan.activity.detail.id".to_string(), "System.String".to_string());
    map.insert(
        "CarePlan.activity.detail.instantiatesCanonical".to_string(),
        "canonical".to_string(),
    );
    map.insert(
        "CarePlan.activity.detail.instantiatesUri".to_string(),
        "uri".to_string(),
    );
    map.insert("CarePlan.activity.detail.kind".to_string(), "code".to_string());
    ...
    map.insert("CareTeam.encounter".to_string(), "Reference".to_string());
    ...
    map.insert(
        "CatalogEntry.additionalCharacteristic".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "CatalogEntry.additionalClassification".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "CatalogEntry.additionalIdentifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert("CatalogEntry.classification".to_string(), "CodeableConcept".to_string());
    map.insert("CatalogEntry.contained".to_string(), "Resource".to_string());
    map.insert("CatalogEntry.extension".to_string(), "Extension".to_string());
    map.insert("CatalogEntry.id".to_string(), "System.String".to_string());
    map.insert("CatalogEntry.identifier".to_string(), "Identifier".to_string());
    map.insert("CatalogEntry.implicitRules".to_string(), "uri".to_string());
    map.insert("CatalogEntry.language".to_string(), "code".to_string());
    map.insert("CatalogEntry.lastUpdated".to_string(), "dateTime".to_string());
    map.insert("CatalogEntry.meta".to_string(), "Meta".to_string());
    map.insert("CatalogEntry.modifierExtension".to_string(), "Extension".to_string());
    map.insert("CatalogEntry.orderable".to_string(), "boolean".to_string());
    map.insert("CatalogEntry.referencedItem".to_string(), "Reference".to_string());
    map.insert("CatalogEntry.relatedEntry".to_string(), "BackboneElement".to_string());
    map.insert(
        "CatalogEntry.relatedEntry.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("CatalogEntry.relatedEntry.id".to_string(), "System.String".to_string());
    map.insert("CatalogEntry.relatedEntry.item".to_string(), "Reference".to_string());
    map.insert(
        "CatalogEntry.relatedEntry.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("CatalogEntry.relatedEntry.relationtype".to_string(), "code".to_string());
    map.insert("CatalogEntry.status".to_string(), "code".to_string());
    map.insert("CatalogEntry.text".to_string(), "Narrative".to_string());
    map.insert("CatalogEntry.type".to_string(), "CodeableConcept".to_string());
    map.insert("CatalogEntry.validTo".to_string(), "dateTime".to_string());
    map.insert("CatalogEntry.validityPeriod".to_string(), "Period".to_string());
    ...
    map.insert(
        "ChargeItem.productCodeableConcept".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("ChargeItem.productReference".to_string(), "Reference".to_string());
    ...
    map.insert("ChargeItemDefinition.effectivePeriod".to_string(), "Period".to_string());
    ...
    map.insert(
        "ClaimResponse.addItem.subSite".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert("ClaimResponse.processNote.type".to_string(), "code".to_string());
    ...
    map.insert(
        "ClinicalImpression.investigation.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("Composition.relatesTo.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("ConceptMap.group.unmapped.url".to_string(), "canonical".to_string());
    ...
    map.insert("ConceptMap.sourceCanonical".to_string(), "canonical".to_string());
    map.insert("ConceptMap.sourceUri".to_string(), "uri".to_string());
    map.insert("ConceptMap.status".to_string(), "code".to_string());
    map.insert("ConceptMap.targetCanonical".to_string(), "canonical".to_string());
    ...
    map.insert("Condition.evidence.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("Condition.recorder".to_string(), "Reference".to_string());
    ...
    map.insert("Consent.performer".to_string(), "Reference".to_string());
    ...
    map.insert("Consent.policy.id".to_string(), "System.String".to_string());
    ...
    map.insert("Consent.policyRule".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("Consent.provision.class".to_string(), "Coding".to_string());
    ...
    map.insert("Consent.provision.type".to_string(), "code".to_string());
    map.insert("Consent.scope".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("Contract.term.action.reason".to_string(), "string".to_string());
    map.insert(
        "Contract.term.action.reasonCode".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("Contract.term.action.reasonLinkId".to_string(), "string".to_string());
    map.insert(
        "Contract.term.action.reasonReference".to_string(),
        "Reference".to_string(),
    );
    ...
    map.insert("Coverage.class.value".to_string(), "string".to_string());
    ...
    map.insert("Device.definition".to_string(), "Reference".to_string());
    map.insert("Device.deviceName".to_string(), "BackboneElement".to_string());
    map.insert("Device.deviceName.extension".to_string(), "Extension".to_string());
    map.insert("Device.deviceName.id".to_string(), "System.String".to_string());
    map.insert(
        "Device.deviceName.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("Device.deviceName.name".to_string(), "string".to_string());
    map.insert("Device.deviceName.type".to_string(), "code".to_string());
    map.insert("Device.distinctIdentifier".to_string(), "string".to_string());
    ...
    map.insert("Device.property.valueCode".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("Device.specialization".to_string(), "BackboneElement".to_string());
    map.insert("Device.specialization.extension".to_string(), "Extension".to_string());
    map.insert("Device.specialization.id".to_string(), "System.String".to_string());
    map.insert(
        "Device.specialization.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "Device.specialization.systemType".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("Device.specialization.version".to_string(), "string".to_string());
    map.insert("Device.status".to_string(), "code".to_string());
    map.insert("Device.statusReason".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("DeviceDefinition.capability".to_string(), "BackboneElement".to_string());
    map.insert(
        "DeviceDefinition.capability.description".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "DeviceDefinition.capability.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "DeviceDefinition.capability.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "DeviceDefinition.capability.type".to_string(),
        "CodeableConcept".to_string(),
    );
    ...
    map.insert(
        "DeviceDefinition.manufacturerReference".to_string(),
        "Reference".to_string(),
    );
    map.insert("DeviceDefinition.manufacturerString".to_string(), "string".to_string());
    ...
    map.insert("DeviceDefinition.onlineInformation".to_string(), "uri".to_string());
    map.insert("DeviceDefinition.owner".to_string(), "Reference".to_string());
    map.insert("DeviceDefinition.parentDevice".to_string(), "Reference".to_string());
    map.insert(
        "DeviceDefinition.physicalCharacteristics".to_string(),
        "ProdCharacteristic".to_string(),
    );
    ...
    map.insert(
        "DeviceDefinition.property.valueCode".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert("DeviceDefinition.quantity".to_string(), "Quantity".to_string());
    ...
    map.insert(
        "DeviceDefinition.specialization".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "DeviceDefinition.specialization.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "DeviceDefinition.specialization.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "DeviceDefinition.specialization.version".to_string(),
        "string".to_string(),
    );
    map.insert("DeviceDefinition.text".to_string(), "Narrative".to_string());
    map.insert("DeviceDefinition.type".to_string(), "CodeableConcept".to_string());
    map.insert(
    ...
    map.insert("DeviceDefinition.url".to_string(), "uri".to_string());
    map.insert("DeviceDefinition.version".to_string(), "string".to_string());
    ...
    map.insert("DeviceUseStatement.basedOn".to_string(), "Reference".to_string());
    ...
    map.insert("DeviceUseStatement.derivedFrom".to_string(), "Reference".to_string());
    ...
    map.insert("DeviceUseStatement.id".to_string(), "System.String".to_string());
    ...
    map.insert(
        "DeviceUseStatement.reasonCode".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "DeviceUseStatement.reasonReference".to_string(),
        "Reference".to_string(),
    );
    ...
    map.insert("DocumentManifest.content".to_string(), "Reference".to_string());
    ...
    map.insert("DocumentManifest.id".to_string(), "System.String".to_string());
    ...
    map.insert("DocumentManifest.related.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("DocumentReference.context.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("DocumentReference.context.related".to_string(), "Reference".to_string());
    map.insert(
    ...
    map.insert("EffectEvidenceSynthesis.approvalDate".to_string(), "date".to_string());
    map.insert(
        "EffectEvidenceSynthesis.author".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.certainty".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "EffectEvidenceSynthesis.certainty.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "EffectEvidenceSynthesis.certainty.note".to_string(),
        "Annotation".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.certainty.rating".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.contact".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.contained".to_string(), "Resource".to_string());
    map.insert("EffectEvidenceSynthesis.copyright".to_string(), "markdown".to_string());
    map.insert("EffectEvidenceSynthesis.date".to_string(), "dateTime".to_string());
    map.insert(
        "EffectEvidenceSynthesis.description".to_string(),
        "markdown".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.editor".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.effectEstimate".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "EffectEvidenceSynthesis.effectEstimate.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "EffectEvidenceSynthesis.effectivePeriod".to_string(),
        "Period".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.endorser".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.exposure".to_string(), "Reference".to_string());
    map.insert(
        "EffectEvidenceSynthesis.exposureAlternative".to_string(),
        "Reference".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.extension".to_string(), "Extension".to_string());
    map.insert("EffectEvidenceSynthesis.id".to_string(), "System.String".to_string());
    map.insert(
        "EffectEvidenceSynthesis.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.implicitRules".to_string(), "uri".to_string());
    map.insert(
        "EffectEvidenceSynthesis.jurisdiction".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.language".to_string(), "code".to_string());
    map.insert("EffectEvidenceSynthesis.lastReviewDate".to_string(), "date".to_string());
    map.insert("EffectEvidenceSynthesis.meta".to_string(), "Meta".to_string());
    map.insert(
        "EffectEvidenceSynthesis.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.name".to_string(), "string".to_string());
    map.insert("EffectEvidenceSynthesis.note".to_string(), "Annotation".to_string());
    map.insert("EffectEvidenceSynthesis.outcome".to_string(), "Reference".to_string());
    map.insert(
        "EffectEvidenceSynthesis.population".to_string(),
        "Reference".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.publisher".to_string(), "string".to_string());
    map.insert(
        "EffectEvidenceSynthesis.relatedArtifact".to_string(),
        "RelatedArtifact".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.resultsByExposure".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "EffectEvidenceSynthesis.reviewer".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.sampleSize".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "EffectEvidenceSynthesis.sampleSize.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("EffectEvidenceSynthesis.status".to_string(), "code".to_string());
    map.insert(
        "EffectEvidenceSynthesis.studyType".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "EffectEvidenceSynthesis.synthesisType".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.text".to_string(), "Narrative".to_string());
    map.insert("EffectEvidenceSynthesis.title".to_string(), "string".to_string());
    map.insert(
        "EffectEvidenceSynthesis.topic".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.url".to_string(), "uri".to_string());
    map.insert(
        "EffectEvidenceSynthesis.useContext".to_string(),
        "UsageContext".to_string(),
    );
    map.insert("EffectEvidenceSynthesis.version".to_string(), "string".to_string());
    ...
    map.insert(
        "ElementDefinition.defaultValueContributor".to_string(),
    ...
    map.insert(
        "ElementDefinition.fixedContributor".to_string(),
        "Contributor".to_string(),
    );
    ...
    map.insert(
        "ElementDefinition.patternContributor".to_string(),
        "Contributor".to_string(),
    );
    ...
    map.insert("Encounter.classHistory.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("Encounter.hospitalization.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert(
        "Encounter.location.physicalType".to_string(),
        "CodeableConcept".to_string(),
    );
    ...
    map.insert("Encounter.reasonCode".to_string(), "CodeableConcept".to_string());
    map.insert("Encounter.reasonReference".to_string(), "Reference".to_string());
    map.insert("Encounter.serviceProvider".to_string(), "Reference".to_string());
    map.insert("Encounter.serviceType".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("Encounter.statusHistory.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("EventDefinition.usage".to_string(), "string".to_string());
    ...
    map.insert("Evidence.effectivePeriod".to_string(), "Period".to_string());
    map.insert("Evidence.endorser".to_string(), "ContactDetail".to_string());
    map.insert("Evidence.exposureBackground".to_string(), "Reference".to_string());
    map.insert("Evidence.exposureVariant".to_string(), "Reference".to_string());
    ...
    map.insert("Evidence.jurisdiction".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("Evidence.outcome".to_string(), "Reference".to_string());
    ...
    map.insert("Evidence.shortTitle".to_string(), "string".to_string());
    map.insert("Evidence.status".to_string(), "code".to_string());
    map.insert("Evidence.subtitle".to_string(), "string".to_string());
    map.insert("Evidence.text".to_string(), "Narrative".to_string());
    map.insert("Evidence.title".to_string(), "string".to_string());
    map.insert("Evidence.topic".to_string(), "CodeableConcept".to_string());
    ...
    map.insert(
        "EvidenceVariable.jurisdiction".to_string(),
        "CodeableConcept".to_string(),
    );
    ...
    map.insert("EvidenceVariable.subtitle".to_string(), "string".to_string());
    ...
    map.insert("EvidenceVariable.topic".to_string(), "CodeableConcept".to_string());
    map.insert("EvidenceVariable.type".to_string(), "code".to_string());
    ...
    map.insert("ExampleScenario.actor.actorId".to_string(), "string".to_string());
    ...
    map.insert("ExampleScenario.actor.name".to_string(), "string".to_string());
    ...
    map.insert("ExampleScenario.instance.name".to_string(), "string".to_string());
    map.insert("ExampleScenario.instance.resourceId".to_string(), "string".to_string());
    map.insert("ExampleScenario.instance.resourceType".to_string(), "code".to_string());
    map.insert(
    ...
    map.insert("ExampleScenario.workflow".to_string(), "canonical".to_string());
    map.insert(
    ...
    map.insert(
        "ExplanationOfBenefit.addItem.subSite".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert("ExplanationOfBenefit.processNote.type".to_string(), "code".to_string());
    ...
    map.insert("Expression.name".to_string(), "id".to_string());
    ...
    map.insert("Extension.valueContributor".to_string(), "Contributor".to_string());
    ...
    map.insert(
        "GraphDefinition.link.target.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("GraphDefinition.link.target.params".to_string(), "string".to_string());
    map.insert(
        "GraphDefinition.link.target.profile".to_string(),
        "canonical".to_string(),
    );
    ...
    map.insert("GraphDefinition.profile".to_string(), "canonical".to_string());
    ...
    map.insert("GuidanceResponse.reasonCode".to_string(), "CodeableConcept".to_string());
    ...
    map.insert(
        "HealthcareService.availableTime.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "HealthcareService.notAvailable.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("ImagingStudy.modality".to_string(), "Coding".to_string());
    ...
    map.insert("ImagingStudy.reasonCode".to_string(), "CodeableConcept".to_string());
    map.insert("ImagingStudy.reasonReference".to_string(), "Reference".to_string());
    ...
    map.insert("Immunization.education".to_string(), "BackboneElement".to_string());
    map.insert("Immunization.education.documentType".to_string(), "string".to_string());
    map.insert("Immunization.education.extension".to_string(), "Extension".to_string());
    map.insert("Immunization.education.id".to_string(), "System.String".to_string());
    map.insert(
        "Immunization.education.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "Immunization.education.presentationDate".to_string(),
        "dateTime".to_string(),
    );
    map.insert(
        "Immunization.education.publicationDate".to_string(),
        "dateTime".to_string(),
    );
    map.insert("Immunization.education.reference".to_string(), "uri".to_string());
    ...
    map.insert("Immunization.reasonCode".to_string(), "CodeableConcept".to_string());
    map.insert("Immunization.reasonReference".to_string(), "Reference".to_string());
    map.insert("Immunization.recorded".to_string(), "dateTime".to_string());
    ...
    map.insert("ImmunizationEvaluation.description".to_string(), "string".to_string());
    map.insert(
        "ImmunizationEvaluation.doseNumberPositiveInt".to_string(),
        "positiveInt".to_string(),
    );
    map.insert(
        "ImmunizationEvaluation.doseNumberString".to_string(),
        "string".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "ImmunizationEvaluation.seriesDosesString".to_string(),
        "string".to_string(),
    );
    ...
    map.insert("InsurancePlan.contact".to_string(), "BackboneElement".to_string());
    map.insert("InsurancePlan.contact.address".to_string(), "Address".to_string());
    map.insert("InsurancePlan.contact.extension".to_string(), "Extension".to_string());
    map.insert("InsurancePlan.contact.id".to_string(), "System.String".to_string());
    map.insert(
        "InsurancePlan.contact.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("InsurancePlan.contact.name".to_string(), "HumanName".to_string());
    map.insert(
        "InsurancePlan.contact.purpose".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("InsurancePlan.contact.telecom".to_string(), "ContactPoint".to_string());
    ...
    map.insert(
        "Invoice.lineItem.priceComponent.amount".to_string(),
        "Money".to_string(),
    );
    map.insert(
        "Invoice.lineItem.priceComponent.code".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "Invoice.lineItem.priceComponent.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "Invoice.lineItem.priceComponent.factor".to_string(),
        "decimal".to_string(),
    );
    map.insert(
        "Invoice.lineItem.priceComponent.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("Invoice.lineItem.priceComponent.type".to_string(), "code".to_string());
    ...
    map.insert("Location.availabilityExceptions".to_string(), "string".to_string());
    ...
    map.insert("Location.hoursOfOperation".to_string(), "BackboneElement".to_string());
    map.insert("Location.hoursOfOperation.allDay".to_string(), "boolean".to_string());
    map.insert("Location.hoursOfOperation.closingTime".to_string(), "time".to_string());
    map.insert("Location.hoursOfOperation.daysOfWeek".to_string(), "code".to_string());
    map.insert(
        "Location.hoursOfOperation.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("Location.hoursOfOperation.id".to_string(), "System.String".to_string());
    map.insert(
        "Location.hoursOfOperation.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("Location.hoursOfOperation.openingTime".to_string(), "time".to_string());
    ...
    map.insert("Measure.group.stratifier.description".to_string(), "string".to_string());
    map.insert(
    ...
    map.insert("Measure.supplementalData.description".to_string(), "string".to_string());
    map.insert(
    ...
    map.insert("MeasureReport.group.measureScore".to_string(), "Quantity".to_string());
    map.insert(
    ...
    map.insert("Media.createdDateTime".to_string(), "dateTime".to_string());
    map.insert("Media.createdPeriod".to_string(), "Period".to_string());
    map.insert("Media.device".to_string(), "Reference".to_string());
    map.insert("Media.deviceName".to_string(), "string".to_string());
    map.insert("Media.duration".to_string(), "decimal".to_string());
    map.insert("Media.encounter".to_string(), "Reference".to_string());
    ...
    map.insert("Medication.ingredient.strength".to_string(), "Ratio".to_string());
    ...
    map.insert("MedicationAdministration.instantiates".to_string(), "uri".to_string());
    ...
    map.insert(
        "MedicationDispense.statusReasonReference".to_string(),
        "Reference".to_string(),
    );
    ...
    map.insert("MedicationKnowledge.amount".to_string(), "Quantity".to_string());
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.contraindication".to_string(),
        "Reference".to_string(),
    );
    map.insert("MedicationKnowledge.cost".to_string(), "BackboneElement".to_string());
    map.insert("MedicationKnowledge.cost.cost".to_string(), "Money".to_string());
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.doseForm".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicationKnowledge.drugCharacteristic".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.drugCharacteristic.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.ingredient".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MedicationKnowledge.ingredient.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicationKnowledge.ingredient.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "MedicationKnowledge.ingredient.isActive".to_string(),
        "boolean".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.ingredient.strength".to_string(),
        "Ratio".to_string(),
    );
    map.insert(
        "MedicationKnowledge.intendedRoute".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicationKnowledge.kinetics".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.kinetics.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.kinetics.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "MedicationKnowledge.kinetics.lethalDose50".to_string(),
        "Quantity".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicationKnowledge.manufacturer".to_string(), "Reference".to_string());
    map.insert(
    ...
    map.insert(
        "MedicationKnowledge.packaging.quantity".to_string(),
        "Quantity".to_string(),
    );
    map.insert(
        "MedicationKnowledge.packaging.type".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicationKnowledge.synonym".to_string(), "string".to_string());
    ...
    map.insert(
        "MedicationRequest.instantiatesCanonical".to_string(),
        "canonical".to_string(),
    );
    map.insert("MedicationRequest.instantiatesUri".to_string(), "uri".to_string());
    ...
    map.insert("MedicationRequest.reportedBoolean".to_string(), "boolean".to_string());
    map.insert(
        "MedicationRequest.reportedReference".to_string(),
        "Reference".to_string(),
    );
    ...
    map.insert(
        "MedicationStatement.statusReason".to_string(),
        "CodeableConcept".to_string(),
    );
    ...
    map.insert("MedicinalProduct.attachedDocument".to_string(), "Reference".to_string());
    map.insert("MedicinalProduct.clinicalTrial".to_string(), "Reference".to_string());
    map.insert(
        "MedicinalProduct.combinedPharmaceuticalDoseForm".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("MedicinalProduct.contact".to_string(), "Reference".to_string());
    map.insert("MedicinalProduct.contained".to_string(), "Resource".to_string());
    map.insert("MedicinalProduct.crossReference".to_string(), "Identifier".to_string());
    map.insert("MedicinalProduct.domain".to_string(), "Coding".to_string());
    map.insert("MedicinalProduct.extension".to_string(), "Extension".to_string());
    map.insert("MedicinalProduct.id".to_string(), "System.String".to_string());
    map.insert("MedicinalProduct.identifier".to_string(), "Identifier".to_string());
    map.insert("MedicinalProduct.implicitRules".to_string(), "uri".to_string());
    map.insert("MedicinalProduct.language".to_string(), "code".to_string());
    map.insert(
        "MedicinalProduct.legalStatusOfSupply".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProduct.marketingStatus".to_string(),
        "MarketingStatus".to_string(),
    );
    map.insert("MedicinalProduct.masterFile".to_string(), "Reference".to_string());
    map.insert("MedicinalProduct.meta".to_string(), "Meta".to_string());
    map.insert(
        "MedicinalProduct.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("MedicinalProduct.name".to_string(), "BackboneElement".to_string());
    map.insert(
        "MedicinalProduct.name.countryLanguage".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProduct.name.countryLanguage.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicinalProduct.name.extension".to_string(), "Extension".to_string());
    map.insert("MedicinalProduct.name.id".to_string(), "System.String".to_string());
    map.insert(
        "MedicinalProduct.name.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProduct.name.namePart".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MedicinalProduct.name.namePart.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProduct.name.namePart.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicinalProduct.name.namePart.part".to_string(), "string".to_string());
    map.insert("MedicinalProduct.name.namePart.type".to_string(), "Coding".to_string());
    map.insert("MedicinalProduct.name.productName".to_string(), "string".to_string());
    map.insert(
        "MedicinalProduct.packagedMedicinalProduct".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProduct.paediatricUseIndicator".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProduct.pharmaceuticalProduct".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProduct.productClassification".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProduct.specialDesignation".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MedicinalProduct.specialDesignation.date".to_string(),
        "dateTime".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProduct.specialDesignation.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProduct.specialDesignation.type".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("MedicinalProduct.specialMeasures".to_string(), "string".to_string());
    map.insert("MedicinalProduct.text".to_string(), "Narrative".to_string());
    map.insert("MedicinalProduct.type".to_string(), "CodeableConcept".to_string());
    map.insert(
        "MedicinalProductAuthorization.contained".to_string(),
        "Resource".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.country".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductAuthorization.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.holder".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicinalProductAuthorization.language".to_string(), "code".to_string());
    map.insert(
        "MedicinalProductAuthorization.legalBasis".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("MedicinalProductAuthorization.meta".to_string(), "Meta".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductAuthorization.regulator".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.restoreDate".to_string(),
        "dateTime".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.status".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.statusDate".to_string(),
        "dateTime".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.subject".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProductAuthorization.text".to_string(),
        "Narrative".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductContraindication.disease".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductContraindication.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductContraindication.language".to_string(),
        "code".to_string(),
    );
    map.insert("MedicinalProductContraindication.meta".to_string(), "Meta".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductContraindication.subject".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProductContraindication.text".to_string(),
        "Narrative".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductIndication.comorbidity".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductIndication.contained".to_string(),
        "Resource".to_string(),
    );
    map.insert(
        "MedicinalProductIndication.diseaseStatus".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductIndication.duration".to_string(),
        "Quantity".to_string(),
    );
    map.insert(
        "MedicinalProductIndication.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("MedicinalProductIndication.id".to_string(), "System.String".to_string());
    map.insert(
        "MedicinalProductIndication.implicitRules".to_string(),
        "uri".to_string(),
    );
    map.insert(
        "MedicinalProductIndication.intendedEffect".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("MedicinalProductIndication.language".to_string(), "code".to_string());
    map.insert("MedicinalProductIndication.meta".to_string(), "Meta".to_string());
    map.insert(
        "MedicinalProductIndication.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProductIndication.otherTherapy".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductIndication.population".to_string(),
        "Population".to_string(),
    );
    map.insert(
        "MedicinalProductIndication.subject".to_string(),
        "Reference".to_string(),
    );
    map.insert("MedicinalProductIndication.text".to_string(), "Narrative".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductIngredient.contained".to_string(),
        "Resource".to_string(),
    );
    map.insert(
        "MedicinalProductIngredient.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("MedicinalProductIngredient.id".to_string(), "System.String".to_string());
    map.insert(
        "MedicinalProductIngredient.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert(
        "MedicinalProductIngredient.implicitRules".to_string(),
        "uri".to_string(),
    );
    map.insert("MedicinalProductIngredient.language".to_string(), "code".to_string());
    map.insert(
        "MedicinalProductIngredient.manufacturer".to_string(),
        "Reference".to_string(),
    );
    map.insert("MedicinalProductIngredient.meta".to_string(), "Meta".to_string());
    map.insert(
        "MedicinalProductIngredient.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProductIngredient.role".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductIngredient.substance".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MedicinalProductIngredient.substance.code".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductIngredient.substance.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicinalProductIngredient.text".to_string(), "Narrative".to_string());
    map.insert(
        "MedicinalProductInteraction.contained".to_string(),
        "Resource".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.description".to_string(),
        "string".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.effect".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.implicitRules".to_string(),
        "uri".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.incidence".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.interactant".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicinalProductInteraction.language".to_string(), "code".to_string());
    map.insert(
        "MedicinalProductInteraction.management".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("MedicinalProductInteraction.meta".to_string(), "Meta".to_string());
    map.insert(
        "MedicinalProductInteraction.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProductInteraction.subject".to_string(),
        "Reference".to_string(),
    );
    map.insert("MedicinalProductInteraction.text".to_string(), "Narrative".to_string());
    map.insert(
        "MedicinalProductInteraction.type".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductManufactured.contained".to_string(),
        "Resource".to_string(),
    );
    map.insert(
        "MedicinalProductManufactured.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProductManufactured.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductManufactured.ingredient".to_string(),
        "Reference".to_string(),
    );
    map.insert("MedicinalProductManufactured.language".to_string(), "code".to_string());
    map.insert(
        "MedicinalProductManufactured.manufacturedDoseForm".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductManufactured.manufacturer".to_string(),
        "Reference".to_string(),
    );
    map.insert("MedicinalProductManufactured.meta".to_string(), "Meta".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductManufactured.quantity".to_string(),
        "Quantity".to_string(),
    );
    map.insert("MedicinalProductManufactured.text".to_string(), "Narrative".to_string());
    map.insert(
        "MedicinalProductManufactured.unitOfPresentation".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductPackaged.batchIdentifier".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicinalProductPackaged.contained".to_string(), "Resource".to_string());
    map.insert("MedicinalProductPackaged.description".to_string(), "string".to_string());
    map.insert(
        "MedicinalProductPackaged.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("MedicinalProductPackaged.id".to_string(), "System.String".to_string());
    map.insert(
        "MedicinalProductPackaged.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert("MedicinalProductPackaged.implicitRules".to_string(), "uri".to_string());
    map.insert("MedicinalProductPackaged.language".to_string(), "code".to_string());
    map.insert(
        "MedicinalProductPackaged.legalStatusOfSupply".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MedicinalProductPackaged.manufacturer".to_string(),
        "Reference".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductPackaged.marketingStatus".to_string(),
        "MarketingStatus".to_string(),
    );
    map.insert("MedicinalProductPackaged.meta".to_string(), "Meta".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductPackaged.packageItem.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductPackaged.packageItem.type".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("MedicinalProductPackaged.subject".to_string(), "Reference".to_string());
    map.insert("MedicinalProductPackaged.text".to_string(), "Narrative".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductPharmaceutical.contained".to_string(),
        "Resource".to_string(),
    );
    map.insert(
        "MedicinalProductPharmaceutical.device".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProductPharmaceutical.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MedicinalProductPharmaceutical.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "MedicinalProductPharmaceutical.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductPharmaceutical.ingredient".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "MedicinalProductPharmaceutical.language".to_string(),
        "code".to_string(),
    );
    map.insert("MedicinalProductPharmaceutical.meta".to_string(), "Meta".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductPharmaceutical.text".to_string(),
        "Narrative".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductUndesirableEffect.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("MedicinalProductUndesirableEffect.meta".to_string(), "Meta".to_string());
    map.insert(
    ...
    map.insert(
        "MedicinalProductUndesirableEffect.subject".to_string(),
        "Reference".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MedicinalProductUndesirableEffect.text".to_string(),
        "Narrative".to_string(),
    );
    map.insert(
    ...
    map.insert("MessageHeader.destination.endpoint".to_string(), "url".to_string());
    map.insert(
    ...
    map.insert("MessageHeader.eventUri".to_string(), "uri".to_string());
    ...
    map.insert("MessageHeader.source.endpoint".to_string(), "url".to_string());
    ...
    map.insert("MolecularSequence.coordinateSystem".to_string(), "integer".to_string());
    ...
    map.insert("MolecularSequence.observedSeq".to_string(), "string".to_string());
    map.insert("MolecularSequence.patient".to_string(), "Reference".to_string());
    map.insert("MolecularSequence.performer".to_string(), "Reference".to_string());
    map.insert("MolecularSequence.pointer".to_string(), "Reference".to_string());
    map.insert("MolecularSequence.quality".to_string(), "BackboneElement".to_string());
    map.insert("MolecularSequence.quality.end".to_string(), "integer".to_string());
    map.insert(
        "MolecularSequence.quality.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("MolecularSequence.quality.fScore".to_string(), "decimal".to_string());
    map.insert("MolecularSequence.quality.gtFP".to_string(), "decimal".to_string());
    map.insert("MolecularSequence.quality.id".to_string(), "System.String".to_string());
    map.insert(
        "MolecularSequence.quality.method".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert("MolecularSequence.quality.precision".to_string(), "decimal".to_string());
    map.insert("MolecularSequence.quality.queryFP".to_string(), "decimal".to_string());
    map.insert("MolecularSequence.quality.queryTP".to_string(), "decimal".to_string());
    map.insert("MolecularSequence.quality.recall".to_string(), "decimal".to_string());
    map.insert(
        "MolecularSequence.quality.roc".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MolecularSequence.quality.roc.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MolecularSequence.quality.roc.fMeasure".to_string(),
        "decimal".to_string(),
    );
    map.insert(
        "MolecularSequence.quality.roc.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("MolecularSequence.quality.roc.numFN".to_string(), "integer".to_string());
    map.insert("MolecularSequence.quality.roc.numFP".to_string(), "integer".to_string());
    map.insert("MolecularSequence.quality.roc.numTP".to_string(), "integer".to_string());
    map.insert(
        "MolecularSequence.quality.roc.precision".to_string(),
        "decimal".to_string(),
    );
    map.insert("MolecularSequence.quality.roc.score".to_string(), "integer".to_string());
    map.insert(
        "MolecularSequence.quality.roc.sensitivity".to_string(),
        "decimal".to_string(),
    );
    map.insert("MolecularSequence.quality.score".to_string(), "Quantity".to_string());
    map.insert(
        "MolecularSequence.quality.standardSequence".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("MolecularSequence.quality.start".to_string(), "integer".to_string());
    map.insert("MolecularSequence.quality.truthFN".to_string(), "decimal".to_string());
    map.insert("MolecularSequence.quality.truthTP".to_string(), "decimal".to_string());
    map.insert("MolecularSequence.quality.type".to_string(), "code".to_string());
    map.insert("MolecularSequence.quantity".to_string(), "Quantity".to_string());
    map.insert("MolecularSequence.readCoverage".to_string(), "integer".to_string());
    map.insert(
        "MolecularSequence.referenceSeq".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MolecularSequence.referenceSeq.chromosome".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "MolecularSequence.referenceSeq.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MolecularSequence.referenceSeq.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("MolecularSequence.referenceSeq.strand".to_string(), "code".to_string());
    map.insert(
        "MolecularSequence.referenceSeq.windowEnd".to_string(),
        "integer".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MolecularSequence.repository".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MolecularSequence.repository.datasetId".to_string(),
        "string".to_string(),
    );
    map.insert(
        "MolecularSequence.repository.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MolecularSequence.repository.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("MolecularSequence.repository.name".to_string(), "string".to_string());
    map.insert(
        "MolecularSequence.repository.readsetId".to_string(),
        "string".to_string(),
    );
    map.insert("MolecularSequence.repository.type".to_string(), "code".to_string());
    map.insert("MolecularSequence.repository.url".to_string(), "uri".to_string());
    map.insert(
        "MolecularSequence.repository.variantsetId".to_string(),
        "string".to_string(),
    );
    map.insert("MolecularSequence.specimen".to_string(), "Reference".to_string());
    map.insert(
        "MolecularSequence.structureVariant".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
        "MolecularSequence.structureVariant.exact".to_string(),
        "boolean".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MolecularSequence.structureVariant.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "MolecularSequence.structureVariant.inner".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MolecularSequence.structureVariant.length".to_string(),
        "integer".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "MolecularSequence.structureVariant.outer".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert("MolecularSequence.variant".to_string(), "BackboneElement".to_string());
    map.insert("MolecularSequence.variant.cigar".to_string(), "string".to_string());
    map.insert("MolecularSequence.variant.end".to_string(), "integer".to_string());
    map.insert(
        "MolecularSequence.variant.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("MolecularSequence.variant.id".to_string(), "System.String".to_string());
    map.insert(
        "MolecularSequence.variant.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "MolecularSequence.variant.observedAllele".to_string(),
        "string".to_string(),
    );
    map.insert(
        "MolecularSequence.variant.referenceAllele".to_string(),
        "string".to_string(),
    );
    map.insert("MolecularSequence.variant.start".to_string(), "integer".to_string());
    map.insert(
        "MolecularSequence.variant.variantPointer".to_string(),
        "Reference".to_string(),
    );
    ...
    map.insert(
        "ObservationDefinition.normalCodedValueSet".to_string(),
        "Reference".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "ObservationDefinition.qualifiedInterval".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "ObservationDefinition.quantitativeDetails".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "ObservationDefinition.validCodedValueSet".to_string(),
        "Reference".to_string(),
    );
    ...
    map.insert("Organization.contact.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert(
        "OrganizationAffiliation.telecom".to_string(),
        "ContactPoint".to_string(),
    );
    ...
    map.insert(
        "Parameters.parameter.valueContributor".to_string(),
        "Contributor".to_string(),
    );
    ...
    map.insert(
        "PaymentReconciliation.detail.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "PaymentReconciliation.detail.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "PaymentReconciliation.detail.predecessor".to_string(),
        "Identifier".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "PaymentReconciliation.detail.responsible".to_string(),
        "Reference".to_string(),
    );
    map.insert(
    ...
    map.insert("PaymentReconciliation.paymentAmount".to_string(), "Money".to_string());
    map.insert("PaymentReconciliation.paymentDate".to_string(), "date".to_string());
    map.insert(
    ...
    map.insert(
        "Population.ageCodeableConcept".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("Population.ageRange".to_string(), "Range".to_string());
    map.insert("Population.extension".to_string(), "Extension".to_string());
    map.insert("Population.gender".to_string(), "CodeableConcept".to_string());
    map.insert("Population.id".to_string(), "System.String".to_string());
    map.insert("Population.modifierExtension".to_string(), "Extension".to_string());
    map.insert(
        "Population.physiologicalCondition".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("Population.race".to_string(), "CodeableConcept".to_string());
    ...
    map.insert(
        "PractitionerRole.availableTime.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "PractitionerRole.notAvailable.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("Procedure.asserter".to_string(), "Reference".to_string());
    ...
    map.insert("Procedure.performedAge".to_string(), "Age".to_string());
    ...
    map.insert("Procedure.performedRange".to_string(), "Range".to_string());
    map.insert("Procedure.performedString".to_string(), "string".to_string());
    ...
    map.insert("ProdCharacteristic.color".to_string(), "string".to_string());
    map.insert("ProdCharacteristic.depth".to_string(), "Quantity".to_string());
    map.insert("ProdCharacteristic.extension".to_string(), "Extension".to_string());
    map.insert(
        "ProdCharacteristic.externalDiameter".to_string(),
        "Quantity".to_string(),
    );
    map.insert("ProdCharacteristic.height".to_string(), "Quantity".to_string());
    map.insert("ProdCharacteristic.id".to_string(), "System.String".to_string());
    map.insert("ProdCharacteristic.image".to_string(), "Attachment".to_string());
    map.insert("ProdCharacteristic.imprint".to_string(), "string".to_string());
    map.insert(
        "ProdCharacteristic.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("ProdCharacteristic.nominalVolume".to_string(), "Quantity".to_string());
    map.insert("ProdCharacteristic.scoring".to_string(), "CodeableConcept".to_string());
    map.insert("ProdCharacteristic.shape".to_string(), "string".to_string());
    map.insert("ProdCharacteristic.weight".to_string(), "Quantity".to_string());
    map.insert("ProdCharacteristic.width".to_string(), "Quantity".to_string());
    ...
    map.insert("ProductShelfLife.identifier".to_string(), "Identifier".to_string());
    map.insert(
        "ProductShelfLife.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("ProductShelfLife.period".to_string(), "Quantity".to_string());
    map.insert(
    ...
    map.insert("Provenance.reason".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("RelatedArtifact.url".to_string(), "url".to_string());
    ...
    map.insert(
        "RequestGroup.action.condition.id".to_string(),
        "System.String".to_string(),
    );
    ...
    map.insert("RequestGroup.action.id".to_string(), "System.String".to_string());
    map.insert(
    ...
    map.insert("RequestGroup.action.prefix".to_string(), "string".to_string());
    map.insert("RequestGroup.action.priority".to_string(), "code".to_string());
    map.insert(
    ...
    map.insert(
        "RequestGroup.action.relatedAction.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("RequestGroup.action.timingAge".to_string(), "Age".to_string());
    ...
    map.insert("RequestGroup.action.type".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("RequestGroup.code".to_string(), "CodeableConcept".to_string());
    map.insert("RequestGroup.contained".to_string(), "Resource".to_string());
    map.insert("RequestGroup.encounter".to_string(), "Reference".to_string());
    ...
    map.insert("RequestGroup.id".to_string(), "System.String".to_string());
    ...
    map.insert(
        "RequestGroup.instantiatesCanonical".to_string(),
        "canonical".to_string(),
    );
    map.insert("RequestGroup.instantiatesUri".to_string(), "uri".to_string());
    ...
    map.insert("RequestGroup.reasonCode".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("ResearchDefinition.approvalDate".to_string(), "date".to_string());
    map.insert("ResearchDefinition.author".to_string(), "ContactDetail".to_string());
    map.insert("ResearchDefinition.comment".to_string(), "string".to_string());
    map.insert("ResearchDefinition.contact".to_string(), "ContactDetail".to_string());
    map.insert("ResearchDefinition.contained".to_string(), "Resource".to_string());
    map.insert("ResearchDefinition.copyright".to_string(), "markdown".to_string());
    map.insert("ResearchDefinition.date".to_string(), "dateTime".to_string());
    map.insert("ResearchDefinition.description".to_string(), "markdown".to_string());
    map.insert("ResearchDefinition.editor".to_string(), "ContactDetail".to_string());
    map.insert("ResearchDefinition.effectivePeriod".to_string(), "Period".to_string());
    map.insert("ResearchDefinition.endorser".to_string(), "ContactDetail".to_string());
    map.insert("ResearchDefinition.experimental".to_string(), "boolean".to_string());
    map.insert("ResearchDefinition.exposure".to_string(), "Reference".to_string());
    map.insert(
        "ResearchDefinition.exposureAlternative".to_string(),
        "Reference".to_string(),
    );
    map.insert("ResearchDefinition.extension".to_string(), "Extension".to_string());
    map.insert("ResearchDefinition.id".to_string(), "System.String".to_string());
    map.insert("ResearchDefinition.identifier".to_string(), "Identifier".to_string());
    map.insert("ResearchDefinition.implicitRules".to_string(), "uri".to_string());
    map.insert(
        "ResearchDefinition.jurisdiction".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("ResearchDefinition.language".to_string(), "code".to_string());
    map.insert("ResearchDefinition.lastReviewDate".to_string(), "date".to_string());
    map.insert("ResearchDefinition.library".to_string(), "canonical".to_string());
    map.insert("ResearchDefinition.meta".to_string(), "Meta".to_string());
    map.insert(
        "ResearchDefinition.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("ResearchDefinition.name".to_string(), "string".to_string());
    map.insert("ResearchDefinition.outcome".to_string(), "Reference".to_string());
    map.insert("ResearchDefinition.population".to_string(), "Reference".to_string());
    map.insert("ResearchDefinition.publisher".to_string(), "string".to_string());
    map.insert("ResearchDefinition.purpose".to_string(), "markdown".to_string());
    map.insert(
        "ResearchDefinition.relatedArtifact".to_string(),
        "RelatedArtifact".to_string(),
    );
    map.insert("ResearchDefinition.reviewer".to_string(), "ContactDetail".to_string());
    map.insert("ResearchDefinition.shortTitle".to_string(), "string".to_string());
    map.insert("ResearchDefinition.status".to_string(), "code".to_string());
    map.insert(
        "ResearchDefinition.subjectCodeableConcept".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "ResearchDefinition.subjectReference".to_string(),
        "Reference".to_string(),
    );
    map.insert("ResearchDefinition.subtitle".to_string(), "string".to_string());
    map.insert("ResearchDefinition.text".to_string(), "Narrative".to_string());
    map.insert("ResearchDefinition.title".to_string(), "string".to_string());
    map.insert("ResearchDefinition.topic".to_string(), "CodeableConcept".to_string());
    map.insert("ResearchDefinition.url".to_string(), "uri".to_string());
    map.insert("ResearchDefinition.usage".to_string(), "string".to_string());
    map.insert("ResearchDefinition.useContext".to_string(), "UsageContext".to_string());
    map.insert("ResearchDefinition.version".to_string(), "string".to_string());
    map.insert("ResearchElementDefinition.approvalDate".to_string(), "date".to_string());
    map.insert(
        "ResearchElementDefinition.author".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.characteristic".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert("ResearchElementDefinition.comment".to_string(), "string".to_string());
    map.insert(
        "ResearchElementDefinition.contact".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.contained".to_string(),
        "Resource".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.copyright".to_string(),
        "markdown".to_string(),
    );
    map.insert("ResearchElementDefinition.date".to_string(), "dateTime".to_string());
    map.insert(
        "ResearchElementDefinition.description".to_string(),
        "markdown".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.editor".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.effectivePeriod".to_string(),
        "Period".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.endorser".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.experimental".to_string(),
        "boolean".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert("ResearchElementDefinition.id".to_string(), "System.String".to_string());
    map.insert(
        "ResearchElementDefinition.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert("ResearchElementDefinition.implicitRules".to_string(), "uri".to_string());
    map.insert(
        "ResearchElementDefinition.jurisdiction".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("ResearchElementDefinition.language".to_string(), "code".to_string());
    map.insert(
        "ResearchElementDefinition.lastReviewDate".to_string(),
        "date".to_string(),
    );
    map.insert("ResearchElementDefinition.library".to_string(), "canonical".to_string());
    map.insert("ResearchElementDefinition.meta".to_string(), "Meta".to_string());
    map.insert(
        "ResearchElementDefinition.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("ResearchElementDefinition.name".to_string(), "string".to_string());
    map.insert("ResearchElementDefinition.publisher".to_string(), "string".to_string());
    map.insert("ResearchElementDefinition.purpose".to_string(), "markdown".to_string());
    map.insert(
        "ResearchElementDefinition.relatedArtifact".to_string(),
        "RelatedArtifact".to_string(),
    );
    map.insert(
        "ResearchElementDefinition.reviewer".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert("ResearchElementDefinition.shortTitle".to_string(), "string".to_string());
    map.insert("ResearchElementDefinition.status".to_string(), "code".to_string());
    map.insert(
    ...
    map.insert("ResearchElementDefinition.subtitle".to_string(), "string".to_string());
    map.insert("ResearchElementDefinition.text".to_string(), "Narrative".to_string());
    map.insert("ResearchElementDefinition.title".to_string(), "string".to_string());
    map.insert(
        "ResearchElementDefinition.topic".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("ResearchElementDefinition.type".to_string(), "code".to_string());
    map.insert("ResearchElementDefinition.url".to_string(), "uri".to_string());
    map.insert("ResearchElementDefinition.usage".to_string(), "string".to_string());
    map.insert(
        "ResearchElementDefinition.useContext".to_string(),
        "UsageContext".to_string(),
    );
    map.insert("ResearchElementDefinition.variableType".to_string(), "code".to_string());
    map.insert("ResearchElementDefinition.version".to_string(), "string".to_string());
    ...
    map.insert("ResearchStudy.arm.id".to_string(), "System.String".to_string());
    map.insert(
        "ResearchStudy.arm.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("ResearchStudy.arm.name".to_string(), "string".to_string());
    map.insert("ResearchStudy.arm.type".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("ResearchStudy.location".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("RiskAssessment.reasonCode".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("RiskEvidenceSynthesis.approvalDate".to_string(), "date".to_string());
    map.insert("RiskEvidenceSynthesis.author".to_string(), "ContactDetail".to_string());
    map.insert(
        "RiskEvidenceSynthesis.certainty".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "RiskEvidenceSynthesis.certainty.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "RiskEvidenceSynthesis.certainty.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "RiskEvidenceSynthesis.certainty.note".to_string(),
        "Annotation".to_string(),
    );
    map.insert(
        "RiskEvidenceSynthesis.certainty.rating".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("RiskEvidenceSynthesis.contact".to_string(), "ContactDetail".to_string());
    map.insert("RiskEvidenceSynthesis.contained".to_string(), "Resource".to_string());
    map.insert("RiskEvidenceSynthesis.copyright".to_string(), "markdown".to_string());
    map.insert("RiskEvidenceSynthesis.date".to_string(), "dateTime".to_string());
    map.insert("RiskEvidenceSynthesis.description".to_string(), "markdown".to_string());
    map.insert("RiskEvidenceSynthesis.editor".to_string(), "ContactDetail".to_string());
    map.insert(
        "RiskEvidenceSynthesis.effectivePeriod".to_string(),
        "Period".to_string(),
    );
    map.insert(
        "RiskEvidenceSynthesis.endorser".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert("RiskEvidenceSynthesis.exposure".to_string(), "Reference".to_string());
    map.insert("RiskEvidenceSynthesis.extension".to_string(), "Extension".to_string());
    map.insert("RiskEvidenceSynthesis.id".to_string(), "System.String".to_string());
    map.insert("RiskEvidenceSynthesis.identifier".to_string(), "Identifier".to_string());
    map.insert("RiskEvidenceSynthesis.implicitRules".to_string(), "uri".to_string());
    map.insert(
        "RiskEvidenceSynthesis.jurisdiction".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("RiskEvidenceSynthesis.language".to_string(), "code".to_string());
    map.insert("RiskEvidenceSynthesis.lastReviewDate".to_string(), "date".to_string());
    map.insert("RiskEvidenceSynthesis.meta".to_string(), "Meta".to_string());
    map.insert(
        "RiskEvidenceSynthesis.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("RiskEvidenceSynthesis.name".to_string(), "string".to_string());
    map.insert("RiskEvidenceSynthesis.note".to_string(), "Annotation".to_string());
    map.insert("RiskEvidenceSynthesis.outcome".to_string(), "Reference".to_string());
    map.insert("RiskEvidenceSynthesis.population".to_string(), "Reference".to_string());
    map.insert("RiskEvidenceSynthesis.publisher".to_string(), "string".to_string());
    map.insert(
        "RiskEvidenceSynthesis.relatedArtifact".to_string(),
        "RelatedArtifact".to_string(),
    );
    map.insert(
        "RiskEvidenceSynthesis.reviewer".to_string(),
        "ContactDetail".to_string(),
    );
    map.insert(
        "RiskEvidenceSynthesis.riskEstimate".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "RiskEvidenceSynthesis.riskEstimate.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "RiskEvidenceSynthesis.riskEstimate.type".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "RiskEvidenceSynthesis.riskEstimate.value".to_string(),
        "decimal".to_string(),
    );
    map.insert(
        "RiskEvidenceSynthesis.sampleSize".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "RiskEvidenceSynthesis.sampleSize.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("RiskEvidenceSynthesis.status".to_string(), "code".to_string());
    map.insert(
        "RiskEvidenceSynthesis.studyType".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "RiskEvidenceSynthesis.synthesisType".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("RiskEvidenceSynthesis.text".to_string(), "Narrative".to_string());
    map.insert("RiskEvidenceSynthesis.title".to_string(), "string".to_string());
    map.insert("RiskEvidenceSynthesis.topic".to_string(), "CodeableConcept".to_string());
    map.insert("RiskEvidenceSynthesis.url".to_string(), "uri".to_string());
    map.insert(
        "RiskEvidenceSynthesis.useContext".to_string(),
        "UsageContext".to_string(),
    );
    map.insert("RiskEvidenceSynthesis.version".to_string(), "string".to_string());
    ...
    map.insert("ServiceRequest.code".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("ServiceRequest.locationCode".to_string(), "CodeableConcept".to_string());
    map.insert("ServiceRequest.locationReference".to_string(), "Reference".to_string());
    ...
    map.insert("ServiceRequest.orderDetail".to_string(), "CodeableConcept".to_string());
    map.insert("ServiceRequest.patientInstruction".to_string(), "string".to_string());
    ...
    map.insert("ServiceRequest.reasonCode".to_string(), "CodeableConcept".to_string());
    map.insert("ServiceRequest.reasonReference".to_string(), "Reference".to_string());
    ...
    map.insert("ServiceRequest.supportingInfo".to_string(), "Reference".to_string());
    ...
    map.insert("Subscription.channel.endpoint".to_string(), "url".to_string());
    ...
    map.insert("Subscription.channel.id".to_string(), "System.String".to_string());
    map.insert(
        "Subscription.channel.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert("Subscription.channel.payload".to_string(), "code".to_string());
    ...
    map.insert("Substance.instance.id".to_string(), "System.String".to_string());
    ...
    map.insert("SubstanceAmount.amountQuantity".to_string(), "Quantity".to_string());
    map.insert("SubstanceAmount.amountRange".to_string(), "Range".to_string());
    map.insert("SubstanceAmount.amountString".to_string(), "string".to_string());
    map.insert("SubstanceAmount.amountText".to_string(), "string".to_string());
    map.insert("SubstanceAmount.amountType".to_string(), "CodeableConcept".to_string());
    map.insert("SubstanceAmount.extension".to_string(), "Extension".to_string());
    map.insert("SubstanceAmount.id".to_string(), "System.String".to_string());
    map.insert("SubstanceAmount.modifierExtension".to_string(), "Extension".to_string());
    map.insert("SubstanceAmount.referenceRange".to_string(), "Element".to_string());
    map.insert(
        "SubstanceAmount.referenceRange.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "SubstanceAmount.referenceRange.highLimit".to_string(),
        "Quantity".to_string(),
    );
    map.insert(
        "SubstanceAmount.referenceRange.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "SubstanceAmount.referenceRange.lowLimit".to_string(),
        "Quantity".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstancePolymer.repeat.numberOfUnits".to_string(),
        "integer".to_string(),
    );
    map.insert(
    ...
    map.insert("SubstanceSpecification.code".to_string(), "BackboneElement".to_string());
    map.insert(
        "SubstanceSpecification.code.code".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("SubstanceSpecification.code.comment".to_string(), "string".to_string());
    map.insert(
        "SubstanceSpecification.code.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "SubstanceSpecification.code.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.code.source".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "SubstanceSpecification.code.status".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.code.statusDate".to_string(),
        "dateTime".to_string(),
    );
    map.insert("SubstanceSpecification.comment".to_string(), "string".to_string());
    map.insert("SubstanceSpecification.contained".to_string(), "Resource".to_string());
    map.insert("SubstanceSpecification.description".to_string(), "string".to_string());
    map.insert(
        "SubstanceSpecification.domain".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("SubstanceSpecification.extension".to_string(), "Extension".to_string());
    map.insert("SubstanceSpecification.id".to_string(), "System.String".to_string());
    map.insert(
        "SubstanceSpecification.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert("SubstanceSpecification.implicitRules".to_string(), "uri".to_string());
    map.insert("SubstanceSpecification.language".to_string(), "code".to_string());
    map.insert("SubstanceSpecification.meta".to_string(), "Meta".to_string());
    map.insert(
        "SubstanceSpecification.modifierExtension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "SubstanceSpecification.moiety".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.moiety.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "SubstanceSpecification.moiety.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "SubstanceSpecification.moiety.identifier".to_string(),
        "Identifier".to_string(),
    );
    map.insert(
    ...
    map.insert("SubstanceSpecification.moiety.name".to_string(), "string".to_string());
    map.insert(
        "SubstanceSpecification.moiety.opticalActivity".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.moiety.role".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert("SubstanceSpecification.name".to_string(), "BackboneElement".to_string());
    map.insert(
        "SubstanceSpecification.name.domain".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.name.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "SubstanceSpecification.name.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "SubstanceSpecification.name.jurisdiction".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.name.language".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert("SubstanceSpecification.name.name".to_string(), "string".to_string());
    map.insert(
        "SubstanceSpecification.name.official".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.name.official.date".to_string(),
        "dateTime".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.name.official.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.name.preferred".to_string(),
        "boolean".to_string(),
    );
    map.insert(
        "SubstanceSpecification.name.source".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "SubstanceSpecification.name.status".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.name.type".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.nucleicAcid".to_string(),
        "Reference".to_string(),
    );
    map.insert("SubstanceSpecification.polymer".to_string(), "Reference".to_string());
    map.insert(
        "SubstanceSpecification.property".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.property.category".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.property.code".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.property.extension".to_string(),
        "Extension".to_string(),
    );
    map.insert(
        "SubstanceSpecification.property.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("SubstanceSpecification.protein".to_string(), "Reference".to_string());
    map.insert(
        "SubstanceSpecification.referenceInformation".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "SubstanceSpecification.relationship".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.relationship.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
    ...
    map.insert("SubstanceSpecification.source".to_string(), "Reference".to_string());
    map.insert(
        "SubstanceSpecification.sourceMaterial".to_string(),
        "Reference".to_string(),
    );
    map.insert(
        "SubstanceSpecification.status".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert(
        "SubstanceSpecification.structure".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.structure.id".to_string(),
        "System.String".to_string(),
    );
    map.insert(
        "SubstanceSpecification.structure.isotope".to_string(),
        "BackboneElement".to_string(),
    );
    map.insert(
    ...
    map.insert(
        "SubstanceSpecification.structure.source".to_string(),
        "Reference".to_string(),
    );
    map.insert(
    ...
    map.insert("SubstanceSpecification.text".to_string(), "Narrative".to_string());
    map.insert("SubstanceSpecification.type".to_string(), "CodeableConcept".to_string());
    ...
    map.insert(
        "SupplyRequest.itemCodeableConcept".to_string(),
        "CodeableConcept".to_string(),
    );
    map.insert("SupplyRequest.itemReference".to_string(), "Reference".to_string());
    ...
    map.insert("SupplyRequest.reasonCode".to_string(), "CodeableConcept".to_string());
    ...
    map.insert("Task.input.valueContributor".to_string(), "Contributor".to_string());
    ...
    map.insert("Task.output.valueContributor".to_string(), "Contributor".to_string());
    ...
    map.insert("Task.reasonCode".to_string(), "CodeableConcept".to_string());
    map.insert("Task.reasonReference".to_string(), "Reference".to_string());
