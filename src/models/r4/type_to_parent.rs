...
pub fn type_to_parent() -> HashMap<String, String> {
    ...
    map.insert("CatalogEntry".to_string(), "DomainResource".to_string());
    ...
    map.insert("Dosage".to_string(), "BackboneElement".to_string());
    map.insert("Duration".to_string(), "Quantity".to_string());
    map.insert("EffectEvidenceSynthesis".to_string(), "DomainResource".to_string());
    map.insert("ElementDefinition".to_string(), "BackboneElement".to_string());
    ...
    map.insert("Expression".to_string(), "Element".to_string());
    ...
    map.insert("MarketingStatus".to_string(), "BackboneElement".to_string());
    ...
    map.insert("MedicinalProduct".to_string(), "DomainResource".to_string());
    map.insert(
    ...
    map.insert("MedicinalProductIndication".to_string(), "DomainResource".to_string());
    map.insert("MedicinalProductIngredient".to_string(), "DomainResource".to_string());
    map.insert("MedicinalProductInteraction".to_string(), "DomainResource".to_string());
    map.insert("MedicinalProductManufactured".to_string(), "DomainResource".to_string());
    map.insert("MedicinalProductPackaged".to_string(), "DomainResource".to_string());
    map.insert(
    ...
    map.insert("Money".to_string(), "Element".to_string());
    ...
    map.insert("Population".to_string(), "BackboneElement".to_string());
    ...
    map.insert("ProdCharacteristic".to_string(), "BackboneElement".to_string());
    map.insert("ProductShelfLife".to_string(), "BackboneElement".to_string());
    ...
    map.insert("ResearchDefinition".to_string(), "DomainResource".to_string());
    map.insert("ResearchElementDefinition".to_string(), "DomainResource".to_string());
    ...
    map.insert("RiskEvidenceSynthesis".to_string(), "DomainResource".to_string());
    ...
    map.insert("SubstanceAmount".to_string(), "BackboneElement".to_string());
    ...
    map.insert("SubstanceSpecification".to_string(), "DomainResource".to_string());
    ...
    map.insert("Timing".to_string(), "BackboneElement".to_string());
