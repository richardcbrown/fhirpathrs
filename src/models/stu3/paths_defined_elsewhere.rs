...
pub fn paths_defined_elsewhere() -> HashMap<String, String> {
    HashMap::from([
        ("Bundle.entry.link".to_string(), "Bundle.link".to_string()),
        (
        ...
        (
            "Contract.term.group".to_string(),
            "Contract.term".to_string(),
        ),
        (
        ...
        (
            "Provenance.entity.agent".to_string(),
            "Provenance.agent".to_string(),
        ),
        (
            "Questionnaire.item.item".to_string(),
            "Questionnaire.item".to_string(),
        ),
        (
